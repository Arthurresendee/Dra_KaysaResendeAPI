...
namespace DRAKaysaResende.Migrations
{
    ...
    [Migration("20240614144225_First Migration")]
            ...
            modelBuilder.Entity("DRAKaysaResende.Models.Plano", b =>
                {
                    ...
                    b.Property<DateTime>("DataInicial")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("SMALLDATETIME")
                        .HasDefaultValue(new DateTime(2024, 6, 14, 11, 42, 24, 984, DateTimeKind.Local).AddTicks(8853))
            ...
            modelBuilder.Entity("DRAKaysaResende.Models.Dentista", b =>
                {
                    b.HasOne("DRAKaysaResende.Models.Endereco", "Endereco")
                        .WithOne("Dentista")
                        .HasForeignKey("DRAKaysaResende.Models.Dentista", "IdEndereco")
            ...
            modelBuilder.Entity("DRAKaysaResende.Models.Paciente", b =>
                {
                    b.HasOne("DRAKaysaResende.Models.Endereco", "Endereco")
                        .WithOne("Paciente")
                        .HasForeignKey("DRAKaysaResende.Models.Paciente", "IdEndereco")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
